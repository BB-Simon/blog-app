...
RSpec.describe 'Users', type: :system do
  describe 'user show page' do
    before do
      ...
      Post.create(author: @first_user, title: 'second', text: 'This is my second post', comments_counter: 0, likes_counter: 0)
      Post.create(author: @first_user, title: 'third', text: 'This is my third post', comments_counter: 0, likes_counter: 0)
