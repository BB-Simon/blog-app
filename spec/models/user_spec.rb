...
describe User, type: :model do
  ...
  it 'user should return top 3 post' do
    ...
    Post.create(author: test_user, title: 'Hello', text: 'This is my second post', comments_counter: 0, likes_counter: 0)
    Post.create(author: test_user, title: 'Hello', text: 'This is my third post', comments_counter: 0, likes_counter: 0)
    Post.create(author: test_user, title: 'Hello', text: 'This is my fourth post', comments_counter: 0, likes_counter: 0)
